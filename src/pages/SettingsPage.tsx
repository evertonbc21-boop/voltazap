...
import { useSettings, type BusinessSettings, type Segment, SEGMENTS } from '../context/SettingsContext'
...
export function SettingsPage() {
  ...
  async function sendTest() {
    ...
    if (cloud.ok) {
      setTestSent(true)
      setToast('Teste enviado com sucesso.')
      return
    }
    ...
    if (cloud.fallbackSuggested) {
      setToast('Abriu o WhatsApp para você concluir o teste.')
    } else {
  ...
  const connectionLabel =
    cloudStatus == null
      ...
      : cloudStatus.configured
        ? 'WhatsApp conectado. Campanhas e conversas enviam automaticamente; respostas aparecem em Mensagens e Resultados.'
        : 'WhatsApp ainda em configuração. Enquanto isso, o envio pode abrir o WhatsApp Web.'
